...
import org.sifrproject.parameters.GroupParameterHandler;
...
public class AnnotatorServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String groups = getFirst(parameters.get("groups"), "");
        ...
        if (!groups.isEmpty()) {
            unknownGroups = GroupParameterHandler.processGroupParameter(parameters, initialSemanticTypes, groups);
        }
        ...
        //annotatorURI = "http://services.bioportal.lirmm.fr/annotator?";


        // test for call to not implemented features
        if (!(score.equals("false") || score.equals("old") || score.equals("cvalue") || score.equals("cvalueh"))) {
            ...
            if (format.equals("brat")) {
                outputContent("application/brat", BRAT.convertAnnotationsToBRAT(queryOutput), response, out);
            } else {
